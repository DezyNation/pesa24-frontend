...
const Index = () => {
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    },
    {
      ...
      field: "metadata",
      cellRenderer: "policyNoCellRenderer",
    },
    {
  ...
  function generateReport(doctype) {
    ...
    BackendAxios.get(
      ...
      .then((res) => {
        ...
        if (doctype == "excel") {
          fileDownload(res.data, "LicReport.xlsx");
        } else {
          fileDownload(res.data, "LicReport.pdf");
        }
      })
      .catch((err) => {
        setReportLoading(false);
  ...
  const policyNoCellRenderer = (params) => {
    return <Text>{JSON.parse(params?.data?.metadata)?.policy_number}</Text>;
  };
          ...
          >
            <AgGridReact
              ...
              components={{
                ...
                policyNoCellRenderer: policyNoCellRenderer,
              }}
