...
const Index = () => {
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    {
      headerName: "CMS Trnxn ID",
      field: "metadata",
      cellRenderer: "trnxnIdCellRenderer",
    },
    {
  ...
  function generateReport(doctype) {
    ...
    BackendAxios.get(
      ...
      .then((res) => {
        ...
        if (doctype == "excel") {
          fileDownload(res.data, "CmsReport.xlsx");
        } else {
          fileDownload(res.data, "CmsReport.pdf");
        }
      })
      .catch((err) => {
        setReportLoading(false);
  ...
  const trnxnIdCellRenderer = (params) => {
    ...
    <>
      <DashboardWrapper pageTitle={"CMS Reports"}>
        ...
        <Stack p={4} spacing={8} w={"full"} direction={["column", "row"]}>
          ...
          <FormControl w={["full", "xs"]}>
            <FormLabel>Ref ID or Trnxn ID</FormLabel>
            <Input
              name="search"
              onChange={Formik.handleChange}
              bg={"white"}
          ...
          >
            <AgGridReact
              ...
              components={{
                ...
                trnxnIdCellRenderer: trnxnIdCellRenderer,
              }}
